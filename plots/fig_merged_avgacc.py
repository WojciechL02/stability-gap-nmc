...
def plot_cifar100x10const(ax, xlabel, ylabel, legend=False):
...
def plot_cifar100x5const(ax, xlabel, ylabel, legend=False):
    assert "WANDB_API_KEY" in os.environ, "WANDB_API_KEY is not set"
    wandb_api_key = os.environ["WANDB_API_KEY"]
    wandb_entity = "stability-gap"
    wandb_project = "cl-teacher-adaptation-src"
...
def plot_cifar100x10grow(ax, xlabel, ylabel, legend=False):
    assert "WANDB_API_KEY" in os.environ, "WANDB_API_KEY is not set"
    wandb_api_key = os.environ["WANDB_API_KEY"]
    wandb_entity = "stability-gap"
    wandb_project = "cl-teacher-adaptation-src"
...
def plot_cifar100x5grow(ax, xlabel, ylabel, legend=False):
    assert "WANDB_API_KEY" in os.environ, "WANDB_API_KEY is not set"
    wandb_api_key = os.environ["WANDB_API_KEY"]
    wandb_entity = "stability-gap"
    wandb_project = "cl-teacher-adaptation-src"
...
def main():
    ...
    plot_cifar100x10const(axes[0], xlabel="Finished Task", ylabel="Average Accuracy")
    plot_cifar100x5const(axes[1], xlabel="Finished Task", ylabel=None)
    plot_cifar100x10grow(axes[2], xlabel='Finished Task', ylabel=None)
    plot_cifar100x5grow(axes[3], xlabel='Finished Task', ylabel=None)

    output_path_png = output_dir / "fig_merged_avgacc.png"
    output_path_pdf = output_dir / "fig_merged_avgacc.pdf"
    plt.tight_layout()
